...
Two of SPECS.md §8's five example derived features are not implemented:
...
# `loan_percent_income` column (the same computation), so it is
...
# perfectly collinear copies of the same signal.
